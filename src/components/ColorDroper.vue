        ...
        <div class="color-choose__colors">
            <div class="color-choose__chooser">
                <label for="first-color" class="color-choose__label">
                    primer color
                    <input type="radio" name="first-color" :checked="choose.includes('first')"
                        @change="chooseColor('first')">
                </label>
                <label for="second-color" class="color-choose__label">
                    segundo color
                    <input type="radio" name="second-color" :checked="choose.includes('second')"
                        @change="chooseColor('second')">
                </label>
            </div>
            <div class="color-choose__box">
                <div class="color-choose__color"
                    :class="first_choose_color ? 'color-choose__color--' + first_choose_color : ''"
                    @click="chooseColor('first')"></div>
                <input class="color-choose__range" type="range" min="0" max="100" @change="defineValue($event, 'first')"
                    v-model="value_first">
                <input class="color-choose__value" v-model="value_first" @change="defineValue($event, 'first')">
            </div>
            <div class="color-choose__box">
                <div class="color-choose__color"
                    :class="second_choose_color ? 'color-choose__color--' + second_choose_color : ''"
                    @click="chooseColor('second')"></div>
                <input class="color-choose__range" type="range" min="0" max="100"
                    @change="defineValue($event, 'second')" v-model="value_second">
